...
export const customTheme = {
  ...
  components: {
    ...
    Menu: {
      ...
      itemHoverColor: colorConfig.menuHoverTextColor, // Hover state color for menu item
      colorItemTextActive: colorConfig.menuActiveTextColor, // Active state color for menu item
      itemHoverBg: colorConfig.menuHoverBgColor, // Background color for hover state
      colorItemBgActive: colorConfig.menuActiveBgColor, // Background color for active state
      itemSelectedColor: colorConfig.menuSelectedTextColor,
      itemSelectedBg: colorConfig.menuSelectedBgColor,
    },
    DatePicker: {
